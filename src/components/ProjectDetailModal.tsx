              ...
              <form onSubmit={handleUploadEvidence} className="space-y-3 pt-3 border-t border-slate-200">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                  ...
                  <div className="flex-1 flex flex-col min-w-[200px]">
                    <label className="text-[10px] font-bold text-slate-700 mb-1">
                      รายละเอียดหลักฐาน <span className="text-rose-500">*</span>
                    </label>
                    <input
                      type="text"
                      required
                      placeholder="กรอกรายละเอียดหลักฐาน (Evidence Details)"
                      value={uploadDescription}
                      onChange={(e) => setUploadDescription(e.target.value)}
                      className="bg-white border border-slate-300 rounded-xl px-3 py-2 text-xs text-slate-900 placeholder:text-slate-400 font-medium w-full focus:outline-none focus:border-[#003B71]"
                    />
                  </div>
